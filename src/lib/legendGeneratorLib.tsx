...
export const CLASS_THEMES: Record<string, SimpleClassTheme> = {
  ...
  Explorateur: { primary: '#bce784', secondary: '#5dd39e', accent: '#348aa7', background: '#171413', danger: '#bce784' },
  Savant:      { primary: '#00ffff', secondary: '#ffff33', accent: '#ffb703', background: '#023047', danger: '#fb8500' },
  Artiste:     { primary: '#d946ef', secondary: '#a855f7', accent: '#d946ef', background: '#0a0008', danger: '#ff0000' },
  Fictionnel:  { primary: '#7c3aed', secondary: '#6366f1', accent: '#8b5cf6', background: '#0d0a1a', danger: '#ff0000' },
