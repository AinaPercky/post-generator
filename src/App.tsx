    ...
    <div className="min-h-screen bg-neutral-50 text-neutral-900 font-sans">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="hidden md:flex bg-neutral-100 p-1 rounded-lg">
            ...
            <button
              ...
              className={`px-4 py-1.5 rounded-md text-sm font-medium transition-colors ${activeTab === 'top5' ? 'bg-white shadow-sm text-neutral-900' : 'text-neutral-500 hover:text-neutral-700'}`}
            >
              Top 5
            </button>
            <button
      ...
      <div className="md:hidden bg-white border-b border-neutral-200 px-4 py-2 flex justify-center">
        <div className="flex bg-neutral-100 p-1 rounded-lg w-full overflow-x-auto">
          ...
          <button
            onClick={() => setActiveTab('top5')}
            className={`flex-1 px-4 py-2 rounded-md text-sm font-medium transition-colors whitespace-nowrap ${activeTab === 'top5' ? 'bg-white shadow-sm text-neutral-900' : 'text-neutral-500 hover:text-neutral-700'}`}
          >
            Top 5
          </button>
          <button
